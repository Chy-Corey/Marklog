<script setup>
// 项目列表页：展示所有项目，含 GitHub / Demo 链接 + 标签
// 数据来自 /api/projects，按 sort_order 升序排列
...
<template>
  <BaseLayout>
    <section class="py-4">
      ...
      <div class="space-y-3">
        <div v-for="project in projects" :key="project.slug" class="card p-5">
          <!-- 标题行 + 外部链接 -->
      ...
      <div v-if="projects.length === 0" class="text-center py-20" style="color: var(--text-tertiary);">
